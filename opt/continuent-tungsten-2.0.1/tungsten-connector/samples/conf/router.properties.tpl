...
waitForDisconnectTimeout=@{ROUTER_WAITFOR_DISCONNECT_TIMEOUT}
#
...
#
routerGatewayPort=@{ROUTER_GATEWAY_PORT}
#
...
# 
managerList=@{DATASERVICE_MEMBERS}
#
...
# configuration
#
delayBeforeOfflineIfNoManager=@{ROUTER_DELAY_BEFORE_OFFLINE}
#
...
#
keepAliveTimeout=@{ROUTER_KEEP_ALIVE_TIMEOUT}
#
